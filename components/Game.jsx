...
export default function Game({ players }) {
  ...
  const IMAGES = [
    ...
    'Everyone offer you their drink. You choose which one to take a drink from',
    'Category, Capital cities',
    'The floor is lava. Anyone who touches the floor in the next round must drink',
    '90s kids drink',
    '00s babies drink',
    ...
    'Most likely to. Who is the most likely to pass out tonight?',
    'Pick a player to drink with you',
    'Blue eyed players drink',
    'Anyone who has eaten during this game must drink',
    'Take some of the drink from the player on your right and put it into your drink',
    'Brunettes drink',
    ...
    'Hug any player',
    'Seven. Go clockwise counting up from 1, but no player can say a multiple of 7 or a number with a 7 in it. Players must replace those numbers with the word "drink" and the direction changes. First player to mess up must drink',
    'Females drink',
